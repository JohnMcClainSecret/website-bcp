...
<body>
    ...
    {{-- textos --}}
    <div class='div'>
        <p style="text-align: justify; margin: 0 15px"> <label style="font-family: BCP BOLD; "> BC Prime</label> le ofrece años combinados de
            ...
            partes negocien y firmen un "Acuerdo de Renta" más detallado, como se contempla a continuación
            en la sección de esta Carta titulada "No vinculante".
            <br> La oferta de renta indicada está garantizada siempre que la descripción de su membresía
    ...
    <div class="justify-content-center" style="margin-top: 20px">
        <table class="table table-striped center" style="margin: 0 120px">
            <tbody>
                <tr>
                    <td style="font-family: BCP BOLD;">OFERTA DE ARRENDAMIENTO:  </td> <td style="font-family: BCP BOLD;">TÉRMINOS DE RENTA</td>
                </tr>
                <tr>
                    <td  width="50%">
                        ...
                        <label style="font-family: BCP BOLD;">Temporada:</label> <label style="font-family: BCP;"> {{$Season}} </label> <br>
                        <label style="font-family: BCP BOLD;">Tarifa de uso actual: </label> <label style="font-family: BCP;">$ {{number_format($Maintenance,2)}} USD</label> <br>
                        <label style="font-family: BCP BOLD;">Semanas a rentar:</label> <label style="font-family: BCP;"> {{$Weeks}} </label> <br>
                        <label style="font-family: BCP BOLD;">Precio por semana:</label> <label style="font-family: BCP;">$ {{ number_format($PerWeek,2)}} USD</label> <br>
                    </td>
                    <td width="50%">
                        <p style="text-align: justify">
                            <label style="font-family: BCP BOLD;"> - Precio: </label>
                            El precio de renta propuesto es de $ {{ number_format($PurchasePrice)}} USD, de los cuales se depositarían en
                            una Cuenta Fiduciaria al aceptar un Acuerdo de Arrendamiento vinculante. El arrendador
                             pagaría el saldo al arrendatario en la fecha de cierre.
                        </p>
                        <p>
                            -<label style="font-family: BCP BOLD;">Comisión: </label>Se cobrará una comisión del 8% al Arrendatario (os) en el momento del cierre.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="font-family: BCP BOLD; text-align: right; font-size: 19px">PRECIO DE RENTA: $ {{ number_format($PurchasePrice)}}  USD</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
    ...
    <div  style="margin: 20px 50px 0px">
        <p style="text-align: justify">
            ...
            contractualmente a las partes y no está destinada a vincularlas contractualmente, y es solo una expresión
            de las condiciones básicas que se incorporarán en un Acuerdo de Arrendamiento vinculante. Esta Carta no
            requiere que ninguna de las partes negocie de buena fe o proceda a completar un Acuerdo de Arrendamiento
            vinculante. Las partes no estarán vinculadas contractualmente a menos que y hasta que celebren un Acuerdo
            de Arrendamiento formal por escrito, que debe tener una forma y un contenido satisfactorios para cada
            parte y para el asesor legal de cada parte, a su entera discreción. Ninguna de las partes puede confiar
            en que esta Carta crea obligación legal de ningún tipo.
        </p>
    </div>
    <footer >
    ...
    <div style="margin: 40px 45px">
        ...
        <p style="text-align: justify">La oferta de esta carta de intención es por un período limitado y
            ...
            <ol type="a" style="font-family: BCP">
                <li >Al firmar esta Oferta de Renta, no se compromete ni está obligado a vender.</li>
                <li>Al firmar esta Oferta de Renta, no renunciará a los derechos de su propiedad.</li>
            </ol>
