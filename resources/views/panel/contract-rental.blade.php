...
<body>
    ...
    @endphp
    <footer>
        <p>© Copyright Business Consultant Prime. All Rights Reseverves</p>
    </footer>
    {{-- logo --}}
    ...
    <div class='div' style="font-family: BCP; padding: 15px; margin: 0 75px">
        ...
        <label style="font-family: BCP BOLD; margin-left: 200px">Email:</label>{{ $contract->Email}} <br> <br>
        ...
        <label style="font-family: BCP BOLD;">Type of Unit:  </label>{{$contract->TypeOfUnit}} <label style="font-family: BCP BOLD; margin-left: 200px">Number of weeks subject to the contract: </label> {{$contract->NumberWeeksSubject}}<br>
        ...
        <label style="font-family: BCP BOLD;">Current usage fee per week: </label>{{ number_format($contract->CurrentUsageFee,2)}} <br>
    </div>
    <table class="div" style=" margin: 0 75px">
        ...
        <tr>
            <td  style="border: hidden; width: 40%; border: hidden;border-right: 2px solid #5c768d ; font-family: BCP BOLD;">Purchase Price: $ {{ number_format($contract->PurchasePrice,2)}} <br>
                Administrative Fee: {{ number_format($contract->AdministrativeFee,2)}}<br>
                TOTAL AMOUNT: {{ number_format($contract->TotalAmount,2)}}
            </td>
    ...
    <div  style="margin: 20px 130px 0px">
        <p style="text-align: justify">
            ...
            Timeshare unit is next available for Buyer's use in 202__.<br>
            ...
            Week number 1 is the first week commencing after January 1 of each year; subsequent
            weeks are numbered consecutively through week number 52 (which shall extend until
            the commencement of the following week number.
        </p>
    </div>
    <hr>
    <div style="margin: 90px 130px">
        <p style="text-align: justify">
            ...
            Buyer will pay Seller the balance of the purchase price at the stipulated closing date, but if
            there is a title agent, then payment shall be to the Title Company.<br><br>
            ...
            -	In the case of Seller(s) terminating this Purchase Agreement before the transaction
            is completed, the Seller(s) agree to pay a Termination Fee of $4,000.00 USD (Four Thousand U.S.
            Dollars) to BC Prime.
            -	Indemnification. In the event of a forfeiture by a prospective Purchaser(s) the Closing
            Company will retain 50% (fifty percent) of such deposits, pay the Broker 8% (Eight Percent)
            and the rest to the Seller(s) as compensation, in this event the broker is obligated to find
            a new buyer for the seller.<br><br>
