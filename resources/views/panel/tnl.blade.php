    ...
    <body>
        ...
        <div>
            ...
            <div style="width: 200px; display: inline-block; margin-top: 6px">
                ...
                @php
                    $date = new Carbon($trust->ClosingDate);
                    $date = $date->format('m-d-Y');
                @endphp
                <div class="input3 top" style=" font-family: Arial, Helvetica, sans-serif;font-size: 11px">{{$date}}</div>
            </div>
        </div>
        ...
        <div style="margin-top: 5px">
            <div style="width: 420px; display: inline-block" >
                <label class="useform"> Address</label>
