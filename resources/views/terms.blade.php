...
<div class="flex-container" style="text-align: justify;">
    <div style="margin-left: auto; margin-right: auto" >
        ...
        <p>The total purchase price for the property shall be the sum of all requirements give </p>
        <ul type='a'>
            <li>This offer is subject to a formal purchase agreement which is forthcoming after accepting this offer.</li>
            <li>The purchaser agrees to deposit the full amount into an escrow and/or trust account, depending on the properties characteristics
                upon providing proof of owenership and signin this purchase offer.
            </li>
        </ul>
        <h5>Comission</h5>
